  ...
  return (
    <Tile className='dialog updates'>
        ...
        <div className='message'>
            ...
            <ul>
              <li>August 26, 2026 - Updated <b>Guests</b> and <b>Panels</b> information</li>
              <li>August 25, 2026 - Updated <b>Guests</b>, <b>Photo Ops</b> and <b>Panels</b> information; fixed <b>Photo Ops</b> sorting bug</li>
