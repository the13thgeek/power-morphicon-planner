  ...
  return (
    <Tile className='dialog updates'>
        ...
        <div className='message'>
            ...
            <ul>
              <li>Aug 27, 2026 - Updated <b>Photo Ops</b> and <b>Panels</b> information</li>
              <li>Aug 26, 2026 - Updated <b>Guests</b> and <b>Panels</b> information</li>
              <li>Aug 25, 2026 - Updated <b>Guests</b>, <b>Photo Ops</b> and <b>Panels</b> information; fixed <b>Photo Ops</b> sorting bug</li>
            </ul>
        </div>
    </Tile>
  )
